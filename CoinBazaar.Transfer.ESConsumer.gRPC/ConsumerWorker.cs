...
namespace CoinBazaar.Transfer.ESConsumer.gRPC
{
    public class ConsumerWorker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            //var _eventStorePersistentSubscription = new EventStorePersistentSubscriptionsClient(new EventStoreClientSettings
            //{
            ...
            //    {
            //        Address = new Uri(_eventStoreOptions.ConnectionString)
            //    }
            //});
